...
var Navigation = function (_React$Component) {
  ...
  function Navigation(props) {
    ...
    _this.history = [view0];
    _this.goto = throttle(_this.goto.bind(_this), TRANSITION_DURATION);
    _this.back = throttle(_this.back.bind(_this), TRANSITION_DURATION);
  ...
  _createClass(Navigation, [{
    ...
    value: function evalPart(Content) {
      if (typeof Content === 'function') {
        return Content.prototype && Content.prototype.render ? React.createElement(Content, null) : Content();
      }
      return Content;
    }
  }, {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          !current.noHeader && (current.title || prev) && (current.header || React.createElement(
            'div',
            ...
            React.createElement(
              ...
              current.title && React.createElement(
                'span',
